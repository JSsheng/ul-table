...
* @return {string|null}
*/
export function getLanguageForBlock(block: Element) {
  ...
  if (!language) {
      ...
      const match = block.className.match(pattern) || (block.parentNode instanceof Element &&  block.parentNode?.className.match(pattern));
...
* @return {boolean}
*/
export function hasCompleteOverlap(start1: number, end1: number, start2: number, end2: number) {
...
* @return {string}
*/
export function htmlEntities(code: string) {
...
* @return {number}
*/
export function indexOfGroup(match: RegExpMatchArray, groupNumber: number) {
  let index = 0;
...
* @return {boolean}
*/
export function intersects(start1: number, end1: number, start2: number, end2: number) {
...
* @return {Array}
*/
export function keys(object: Record<string, any>) {
  ...
  // numeric descending
  return locations.sort((a, b) => Number(b) - Number(a));
}
...
* @return {string}
*/
export function replaceAtPosition(position: number, replace: string, replaceWith: string, code: string) {
...
* @return {Worker}
*/
export function createWorker(fn: Function, Prism: Prism) {
  if (isNode()) {
